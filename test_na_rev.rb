...
if (Gem.win_platform? and ARGV[0])
	name = argument.encode(ARGV[0].encoding).encode("UTF-8")
end
...
questions = [
	...
	"Чем чаще он говорит о своих чувствах, тем меньше верите?",
...
results = [
	...
	# 5-9 ответов "да"
	"Ваша ревность действует на вас мобилизирующе, но не она одна управляет вашим поведением. " +
